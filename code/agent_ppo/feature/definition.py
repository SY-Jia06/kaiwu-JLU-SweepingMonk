...
ObsData = create_cls("ObsData", feature=None, legal_action=None, critic_feature=None)
...
SampleData = create_cls(
    "SampleData",
    obs=Config.DIM_OF_OBSERVATION,  # 81D feature vector / 特征向量
    critic_obs=Config.CRITIC_EXTRA_DIM,  # 19D critic-only global feature / Critic 专用全局特征
